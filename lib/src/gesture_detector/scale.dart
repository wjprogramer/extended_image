...
class ExtendedScaleUpdateDetails extends ScaleUpdateDetails {
  ...
  @override
  // _currentFocalPoint - _initialFocalPoint
  // /// The amount the pointer has moved in the coordinate space of the event
  // /// receiver since the previous total update .
  // ///
  // /// Defaults to zero if not specified in the constructor.
  // ignore: overridden_fields
  final Offset delta;

  // _currentFocalPoint - (_preFocalPoint ?? _initialFocalPoint)
  // /// The amount the pointer has moved in the coordinate space of the event
...
/// The possible states of a [ExtendedScaleGestureRecognizer].
enum _ScaleState {
...
class ExtendedScaleGestureRecognizer extends OneSequenceGestureRecognizer {
  ...
  void _advanceStateMachine(
      bool shouldStartIfAccepted, PointerDeviceKind pointerDeviceKind) {
    ...
    if (_state == _ScaleState.started && onUpdate != null) {
      invokeCallback<void>('onUpdate', () {
        onUpdate!(ExtendedScaleUpdateDetails(
            scale: _scaleFactor,
      ...
      _preFocalPoint = _currentFocalPoint;
    }
  }
